...
interface ResponsibilityCreationAttributes extends Optional<ResponsibilityAttributes, "id"> {}

class Responsibility extends Model<ResponsibilityAttributes, ResponsibilityCreationAttributes>
